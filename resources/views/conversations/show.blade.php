         ...
         <div class="border-t-2 border-gray-200 px-4 pt-4 mb-2 sm:mb-0">
            <form method="POST" action="{{ route('conversation.store')}}">
               <div class="relative flex">
                  ...
                  <input name="question" type="text" placeholder="Write your message!" class="w-full focus:outline-none focus:placeholder-gray-400 text-gray-600 placeholder-gray-600 pl-12 bg-gray-200 rounded-md py-3">
                  <div class="absolute right-0 items-center inset-y-0 hidden sm:flex">

                     <input value="Send" type="submit" class="inline-flex items-center justify-center rounded-lg px-4 py-3 transition duration-500 ease-in-out text-white bg-blue-500 hover:bg-blue-400 focus:outline-none" />
